                    ...
                    <div class="mt-2 grid grid-cols-1">
                        <form action="php/agregarimg.php" method="post" enctype="multipart/form-data">
                            <div class="mt-2 grid grid-cols-5">
                                <label for="fileToUpload1" class="btn">
                                    <img src="img/imagen.png"></label>
                                <input type="file" name="fileToUpload1" id="fileToUpload1" class="hidden" accept="image/jpg">
                            </div>
                            <button type="submit" class="rounded bg-green-500 text-white p-2 text-xl mt-5 hover:bg-green-400">Guardar Nueva Rifa</button>
                        </form>
                    </div>
                </div>
        </div>
