...
<head>
    <meta charset="UTF-8">
    <title>Rifas el Tapatio - Login</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="css/sidebar.css">
</head>
<body>
<div class="flex min-h-full items-center justify-center py-12 px-4 mt-4 mx-1 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
        <div>
            <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company">
            <h1 class="mt-6 text-center text-4xl font-bold tracking-tight text-gray-900">Rifas el Tapatío</h1>
